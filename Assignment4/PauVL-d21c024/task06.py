...
#vcard_rdf:Works a rdfs:Property
resource = (vcard_rdf.Works,RDF.type,RDF.Property)
g.add(resource)

#vcard_rdf:Works rdfs:range ns:University
resource = (vcard_rdf.Works,RDFS.range,ns.University)
g.add(resource)

#vcard_rdf:Works rdfs:domain ns:Person
resource = (vcard_rdf.Works,RDFS.domain,ns.Person)
g.add(resource)
...
resource = (ns.JohnSmith,vcard_rdf.Works,ns.UPM)
g.add(resource)
